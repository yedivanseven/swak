...
### Changed
- All Readers/Loaders now adhere to the same string-interpolation scheme as the Writers/Savers
- The "path" in all Writers/Savers now defaults to a singel placeholder string "{}"


## [1.1.2] - 2026-07-05

### Fixed
- Docstring of pandas Interpolate


## [1.1.1] - 2026-07-05

### Changed
- Pandas Join no accepts multiple dataframes
- Funcflow concurrent fork no defaults to the number of workers equal to the number of callables

### Added
- Pandas and Polars interpolate


## [1.1.0] - 2026-06-28

### Fixed
- File system prefix in Find
...
### Changed
- Updated text resource reader from pkgutil to importlib.resources


## [1.0.8] - 2026-06-20

### Fixed
- JsonObject class annotation bug


## [1.0.7] - 2026-06-13

### Added
- polars head, tail, concat, and to_torch


## [1.0.6] - 2026-06-05

### Added
- pandas drop-duplicates and polars unique
...
### Fixed
- JsonObject for python 3.14


## [1.0.4] - 2026-04-23

### Added
- Sinusoidal and learnable positional encodings now have an offset


## [1.0.3] - 2026-04-22

### Changed
- Changed init signature of the transformer encoder layer
...
## [1.0.2] - 2026-04-20
### Fixed
- Adhered to stricter abstract base classes in transformer subpackage
- Norm-first logic in EncoderLayer

### Changed
- Factored merge-mask logic out of encoder forward


## [1.0.1] - 2026-04-16
- Removed redundant parameter from cross-attention feature mixer
