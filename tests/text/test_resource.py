...
# import unittest
# # from unittest.mock import patch  # No longer needed after pkgutil -> importlib.resources migration
# from swak.io import NotFound
# from swak.text import TextResourceLoader
#
#
...
#         self.assertTrue(callable(load))
#
#     # Replaced by importlib.resources.files(); patch target
#     # 'swak.text.resource.pkgutil.get_data' no longer exists.
#     # Path construction is covered by the real integration tests below.
#     #
#     # @patch('swak.text.resource.pkgutil.get_data')
#     # def test_pkgutil_called(self, mock):
#     #     load = TextResourceLoader('tests.text')
