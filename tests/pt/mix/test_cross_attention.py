...
import torch as pt
from swak.pt.mix import CrossAttentionMixer


class TestDefaultAttributes(unittest.TestCase):

    def setUp(self):
        self.mix = CrossAttentionMixer(4)
    ...
    def test_call_new(self):
        new = self.mix.new()
        self.assertIsInstance(new, CrossAttentionMixer)
        self.assertIsNot(new, self.mix)
        self.assertIsNot(new.query, self.mix.query)
