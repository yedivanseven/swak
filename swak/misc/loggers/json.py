...
class JsonStreamHandler(StreamHandler):
    """StreamHandler for logging JSON messages.
    ...
    **extras
    ...
    ValueError
        ...
        `fields` are not a permissible log-record attribute.
    ...
    def __permissible(self, fields: str | Iterable[str]) -> set[str]:
        ...
        return {self.__whitelisted(str(field).strip()) for field in fields}
    ...
    def basics(self) -> set[str]:
        """Log-record attributes to add to the log message."""
